...
# Open "Minkraft" with its own dedicated sessions.
PROJ="Minkraft"
DRIVE="/run/media/hubertg/SONIC"
DATA="/run/media/hubertg/SONIC/OpenCodeBox/project-data/Minkraft/.opencode-data"
SESSIONS_DIR="/run/media/hubertg/SONIC/OpenCodeBox/project-data/Minkraft/sessions"
...
export OPENCODE_CONFIG="/run/media/hubertg/SONIC/OpenCodeBox/project-data/Minkraft/opencode.json"
